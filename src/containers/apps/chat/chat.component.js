	...
	render() {
		return (
			<div className={scss['chat-wrapper']}>
				<ChatList selected={this.state.selectedChat} list={recentChats} onSelect={this.selectChat} />
				{this.state.selectedChat ? <ChatMessages chat={this.state.selectedChat} onSend={this.sendMessage} /> : <NoMessages />}
				<Snackbar
					anchorOrigin={{
						vertical: 'bottom',
						horizontal: 'right'
