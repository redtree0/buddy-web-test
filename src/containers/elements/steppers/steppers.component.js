			...
			<Grid container spacing={0}>
				...
				<Grid item xs={10}>
					<Paper className="portal-pages__content-inner">
						...
						<p>
							The Stepper can be controlled by passing the current step index (zero-based) as the activeStep property. Stepper
							orientation is set using the orientation property.
						</p>
