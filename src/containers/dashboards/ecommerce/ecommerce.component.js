			...
			<Grid item xs={12}>
				<Grid container justify="center" spacing={16}>
					...
					<Grid key={3} item xs={12} sm={12} md={4} className={classes.portalWidget}>
						<Paper className={classes.portalWidgetContent}>{/* <ActiveUsersWidget /> */}</Paper>
					</Grid>

					<Grid item xs={12} sm={12} md={8}>
						<Grid container justify="center" spacing={16}>
							<Grid key={4} item xs={12} className={classes.portalWidget}>
								<Paper className={classes.portalWidgetContent}>{/* <DailySalesWidget /> */}</Paper>
							</Grid>

							<Grid key={5} item xs={12} className={classes.portalWidget}>
								<Paper className={classes.portalWidgetContent}>{/* <TableWidget /> */}</Paper>
							</Grid>
						</Grid>
					</Grid>

					<Grid key={6} item xs={12} sm={12} md={4} className={classes.portalWidget}>
						<Paper className={classes.portalWidgetContent}>{/* <RegionSalesWidget /> */}</Paper>
					</Grid>
				</Grid>
			</Grid>
		</div>
