						...
						<Card className={classNames(scss.card, classes['primary-card'])}>
							<CardContent className={scss['signup-content']}>
								...
								<Typography component="p" gutterBottom>
									Welcome It takes a couple of minutes to sign up for a free account. Just fill in your details to gain
									access the admin panel and view the dashboard. By creating an account, you agree to our Terms &
									Conditions and Privacy Policy.
								</Typography>
							</CardContent>
							<CardActions>
								<Button fullWidth href="/login" color="secondary" variant="raised">
						...
						<Card className={scss.card}>
							<CardContent>
								<Grid container>
									...
									<Grid item xs={12}>
										<TextField label="Repeat Password" fullWidth type="password" />
									</Grid>
								</Grid>
							</CardContent>
							<CardActions>
								<Button fullWidth href="/register" color="primary" variant="raised">
									Register
								</Button>
							</CardActions>
						</Card>
