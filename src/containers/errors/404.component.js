		...
		<div className={classes.background}>
			<Card className={scss.card} raised>
				<CardContent className={scss['card-content']}>
					...
					<Typography className={scss['card-text']}>Sorry the page you were looking for could not be found.</Typography>
					<Input className={scss['card-search-input']} placeholder="Search Portal" endAdornment={<SearchIcon />} />
				</CardContent>
