			...
			<Grid container spacing={0}>
				...
				<Grid item xs={10}>
					<Paper className="portal-pages__content-inner">
						...
						<p>
							A <a href="https://material.google.com/style/typography.html#typography-styles">typographic scale</a> has a
							limited set of type sizes that work well together along with the layout grid.
						</p>

						<p>
							These sizes and styles were developed to balance content density and reading comfort under typical usage
							conditions.
						</p>
