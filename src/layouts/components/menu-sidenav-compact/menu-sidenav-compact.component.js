							...
							item.href ? (
								<ListItem
									...
									className={`${classes.listItemRoot} ${
										window.location.pathname === item.href ? classes.listItemActive : ''
									}`}
									disableGutters
									component={NavLink}
									to={item.href}
								...
								item.children && (
									<ListItem className={classes.listItemRoot} disableGutters key={item.title}>
										<Button
										...
										>
											{item.children.map((child) => (
												<MenuItem
													// exact
													className={({ isActive }) => (isActive ? classes.listItemActive : '')}
													component={NavLink}
													to={child.href}
													key={child.title}
