		...
		return (
			<div className={classNames(scss['layout-classic-wrapper'], classes.wrapper)}>
				...
				<main className={scss['layout-classic-main']}>
					<AppBar color="default" position="static" style={{ boxShadow: 'none', borderBottom: 'solid 1px #c5c5c5' }}>
						<ContentToolbar />
					</AppBar>
					<div className={scss['layout-classic-content-wrapper']}>
						<div className={scss['layout-classic-content']}>{children}</div>
					</div>
					<ContentFooter />
				</main>
				<NotificationSidenav />
